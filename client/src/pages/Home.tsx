        ...
        <div className="relative container z-10 py-20 lg:py-28">
          <div className="max-w-3xl">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-white text-sm font-medium">{SITE_DATA.googleReviews.rating} Stars · {SITE_DATA.googleReviews.count} Google Reviews · Werribee's Most Trusted Mechanic</span>
            </div>
      ...
      <section className="bg-gray-50 py-12 lg:py-16 border-b border-gray-200">
        <div className="container">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-6 items-center justify-items-center">
            {[
              { name: "Toyota", logo: "/logos/brands/toyota.png" },
              { name: "Mazda", logo: "/logos/brands/mazda.png" },
              { name: "Hyundai", logo: "/logos/brands/hyundai.png" },
              { name: "Kia", logo: "/logos/brands/kia.png" },
              { name: "Ford", logo: "/logos/brands/ford.png" },
              { name: "Holden", logo: "/logos/brands/holden.png" },
              { name: "Mitsubishi", logo: "/logos/brands/mitsubishi.png" },
              { name: "Nissan", logo: "/logos/brands/nissan.png" },
              { name: "Honda", logo: "/logos/brands/honda.png" },
              { name: "Subaru", logo: "/logos/brands/subaru.png" },
              { name: "Volkswagen", logo: "/logos/brands/volkswagen.png" },
              { name: "BMW", logo: "/logos/brands/bmw.png" },
              { name: "Mercedes-Benz", logo: "/logos/brands/mercedes-benz.png" },
              { name: "Audi", logo: "/logos/brands/audi.png" },
              { name: "Lexus", logo: "/logos/brands/lexus.png" },
              { name: "Isuzu", logo: "/logos/brands/isuzu.png" },
              { name: "MG", logo: "/logos/brands/mg.png" },
              { name: "Tesla", logo: "/logos/brands/tesla.png" },
              { name: "Suzuki", logo: "/logos/brands/suzuki.png" },
              { name: "Skoda", logo: "/logos/brands/skoda.png" },
              { name: "Volvo", logo: "/logos/brands/volvo.png" },
              { name: "Land Rover", logo: "/logos/brands/land-rover.png" },
              { name: "Jeep", logo: "/logos/brands/jeep.png" },
              { name: "Renault", logo: "/logos/brands/renault.png" },
              { name: "Peugeot", logo: "/logos/brands/peugeot.png" },
              { name: "GWM", logo: "/logos/brands/gwm.png" },
              { name: "Haval", logo: "/logos/brands/haval.png" },
              { name: "BYD", logo: "/logos/brands/byd.png" },
              { name: "Mahindra", logo: "/logos/brands/mahindra.png" },
            ].map((brand, i) => (
          ...
          <FadeIn>
            <div className="text-center mb-12">
              ...
              <h2
                ...
                style={{ fontFamily: "'Oswald', sans-serif" }}
              >
                {SITE_DATA.googleReviews.displayCount} GOOGLE REVIEWS.
                <br />
                <span style={{ color: "#CC2229" }}>{SITE_DATA.googleReviews.rating} STARS OVERALL.</span>
              </h2>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={400}>
            <div className="text-center mt-8">
              ...
              >
                ...
                Read all {SITE_DATA.googleReviews.count} reviews on Google
              </a>
            </div>
          </FadeIn>
        </div>
